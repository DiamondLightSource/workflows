...
struct CreateArgs {
    ...
    name: String,
    /// Option to create conventional WorkflowTemplate folder
    #[arg(long)]
    manifest: bool,
    /// Option to create helm-based WorkflowTemplate folder
    #[arg(long)]
    helm: bool,
    /// Path to module home directory where boilerplate files are stored
